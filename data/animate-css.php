...
return array(
	...
	__( 'Sliding Entrances' )  => array(
		'slideInUp'    => __( 'slideInUp' ),
		'slideInDown'  => __( 'slideInDown' ),
		'slideInLeft'  => __( 'slideInLeft' ),
		'slideInRight' => __( 'slideInRight' ),
	),
	__( 'Sliding Exits' )      => array(
		'slideOutUp'    => __( 'slideOutUp' ),
		'slideOutDown'  => __( 'slideOutDown' ),
		'slideOutLeft'  => __( 'slideOutLeft' ),
		'slideOutRight' => __( 'slideOutRight' ),
	),
	__( 'Zoom Entrances' )     => array(
		'zoomIn'      => __( 'zoomIn' ),
