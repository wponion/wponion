...
(function ($) {
	...
	$.fn.WPOnionCloner = function (options) {
		...
		var $_wrap = $(this),
			...
			var $count = parseInt($_wrap.attr('data-wponion-clone-count')) - 1;
		...
		$add.on('click', function () {
			var $limit = parseInt($_wrap.attr('data-wponion-clone-count')),
			...
			var $_remove = $_wrap.find($options['remove_btn']);
...
//# sourceMappingURL=wponion-cloner.js.map