...
if ( ! class_exists( '\WPOnion\Theme\WP_Lite' ) ) {
	 ...
	 * @since 1.0
	 */
	class WP_Lite extends \WPOnion\Theme_API {
		/**
		 * WP constructor.
		 *
		 * @param $data
		...
		public function register_assets() {
			wp_enqueue_style( 'wponion-wp-lite', $this->url( 'assets/style.css' ), array( 'wponion-core' ) );
			wp_enqueue_script( 'wponion-wp-lite', $this->url( 'assets/script.js' ), array( 'wponion-core' ) );
		}
